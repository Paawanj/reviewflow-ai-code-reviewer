...
import { createPullRequestReview, getPullRequestReviewHistory, getPullRequests } from "@/services/githubApi";
...
export default function PullRequestsPage() {
  ...
  async function reviewPullRequest(pullNumber) {
    ...
    try { const data = await createPullRequestReview(selectedRepository.owner, selectedRepository.repo, pullNumber); setReviewsByNumber((current) => ({ ...current, [pullNumber]: { review: data.review, contextUsed: data.contextUsed || [] } })); }
